...
from utils import (
    get_summary_from_gpt4turbo,get_summary_from_sagemaker,
    prompt2,
...
def main():
    ...
    s3.upload_file(f'/home/ubuntu/lds/lds_image/image_cache/output_images/{filename}','testlds' , f'Output/{filename}')
